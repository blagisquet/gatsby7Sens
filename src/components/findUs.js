...
const FindUs = ({ className }) => {
  return (
    <div className={className}>
      ...
      <a href="https://goo.gl/maps/NLDzBV8N3Qf8wB9E8" className="is-hidden-tablet" target="_blank" rel="noopener noreferrer">          
      <h4 className="title is-size-4">Voir sur Google Maps</h4>
        <div className="image imageMob">
        </div>
      </a>
      <a href="https://goo.gl/maps/NLDzBV8N3Qf8wB9E8" className="is-hidden-mobile" target="_blank" rel="noopener noreferrer">          
      <h4 className="title is-size-4">Voir sur Google Maps</h4>
        <div className="image imageDesk">
        </div>
      </a>
    </div>
  );
